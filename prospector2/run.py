...
from prospector2 import blender, postfilter, tools
from prospector2.config import configuration as cfg
...
from prospector2.message import Location, Message
from prospector2.tools.utils import capture_output
